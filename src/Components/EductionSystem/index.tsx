...
const EducationSystem = () => {
  ...
  return (
    ...
    <div className="bg-[#FFE4B5]">
      <div>
        <h1 className="text-[#FF5F6D] font-montserratExtrabold flex justify-center md:py-16 py-8 px-12 md:px-24   md:text-7xl text-4xl ">
      ...
      <div className="container mx-auto pb-24">
        <div className="grid md:grid-cols-2  grid-cols-1 justify-center gap-8 md:px-0 px-4">
          {[1, 2, 3, 4].map(index => {
            return (
              <div key={index} >
                <h3 className="text-[#62A0E3] font-montserratBold flex justify-center py-4">
                  Morning Age 4-5
                </h3>
                <div className="relative hover:scale-105 transform transition-all duration-300 hover:z-10">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="103.353" height="65">
    <path
      fill="#fff"
      fillRule="evenodd"
